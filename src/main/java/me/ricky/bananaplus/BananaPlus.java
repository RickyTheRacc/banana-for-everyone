package me.ricky.bananaplus;

import com.mojang.logging.LogUtils;
import me.ricky.bananaplus.hud.*;
import me.ricky.bananaplus.modules.*;
import me.ricky.bananaplus.systems.BananaTab;
import me.ricky.bananaplus.utils.StatsUtil;
...
public class BananaPlus extends MeteorAddon {
	...
	static {
		ModMetadata metadata = FabricLoader.getInstance().getModContainer("bananaplus").orElseThrow().getMetadata();
	...
	public void onInitialize() {
		...
		// Starscript
		MeteorStarscript.ss.set("bananaplus", new ValueMap()
