...
public class SurroundClicker extends Module {
    ...
    public SurroundClicker() {
        super(BananaPlus.FIXED, "surround-clicker", "Mess with russian surround users by clicking their entire surround.");
    }
