...
public class AntiNarrator extends Module {
    ...
    public AntiNarrator() {
        super(AddModule.BANANAMINUS, "anti-narrator", "Stops the annoying narrator from popping up. Cancel = Cancel event when you press Ctrl+B, Disable = Automatically disables narrator when you turn it on.");
    }
