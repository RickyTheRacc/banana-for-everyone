...
public class JumpIndicator extends Module {
    ...
    public JumpIndicator() {
        super(AddModule.BANANAMINUS, "jump-indicator", "Draws a circle around you when you jump to help with movement. [Credit to Meteor Rejects for rendering maths]");
    }
