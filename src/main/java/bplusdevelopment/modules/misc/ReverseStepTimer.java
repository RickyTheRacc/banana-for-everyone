...
public class ReverseStepTimer extends Module {
    ...
    public ReverseStepTimer() {
        super(AddModule.BANANAPLUS, "reverse-step-timer", "Tries to bypass strict server for reverse step.");
    }

    private int fallTicks;
    private final bplusdevelopment.utils.Timer strictTimer = new bplusdevelopment.utils.Timer();
