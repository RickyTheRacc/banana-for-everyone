package bplusdevelopment.modules.hud;
...
public class MonkeBombsHud extends HudElement {
    ...
    public MonkeBombsHud(HUD hud) {
        super(hud, "MonkeBombs", "Displays the amount of crystals in your inventory.", false);
    }
