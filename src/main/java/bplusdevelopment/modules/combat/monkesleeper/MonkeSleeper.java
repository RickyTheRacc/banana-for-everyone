...
public class MonkeSleeper extends Module {
    ...
    public final Setting<ConTypeInclAlways> holdWhen = sgHold.add(new EnumSetting.Builder<ConTypeInclAlways>()
            .name("hold-when")
    ...
    public MonkeSleeper() {
        super(AddModule.BANANAPLUS, "monke-sleeper", "Automatically places and attacks beds.");
    }
