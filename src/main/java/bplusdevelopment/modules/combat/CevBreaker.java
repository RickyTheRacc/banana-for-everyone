...
public class CevBreaker extends Module {
    ...
    public CevBreaker() { super(AddModule.BANANAPLUS, "cev-breaker", "Automatically places an obsidian block and a crystal on top of the target and breaks the obby and crystal to deal massive damage."); }
