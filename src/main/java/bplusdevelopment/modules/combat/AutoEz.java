...
import bplusdevelopment.utils.EzUtil;
import bplusdevelopment.utils.ServerUtils.BPlusPacketUtils;
...
public class AutoEz extends Module {
    ...
    public AutoEz() {
        super(AddModule.BANANAPLUS, "auto-monke", "(kills) = kill count, (KS) = killstreak, (enemy) = player u killed, (KD) = kills/deaths, u can also use starscript {} see doc down below");
    }
